...
*/
public class CarZoom implements Icon
{
   ...
   */
   ...
   public static void main(String[] args) {
	   ...
	   frame.setTitle("Car Zoom In / Out Function");
	   CarZoom car = new CarZoom(400);
	   ...
	   {
		   car.changeWidth(car.getIconWidth() * 2);
		   label.repaint();
	   });
	   frame.add(zoomIn);
